<span data-ttu-id="e4480-101">Aşağıdaki .NET Core CLI komutları çalıştırın:</span><span class="sxs-lookup"><span data-stu-id="e4480-101">Run the following .NET Core CLI commands:</span></span>
