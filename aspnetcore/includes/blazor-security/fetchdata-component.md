<span data-ttu-id="040f5-101">`FetchData` Bileşen şunları gösterir:</span><span class="sxs-lookup"><span data-stu-id="040f5-101">The `FetchData` component shows how to:</span></span>
