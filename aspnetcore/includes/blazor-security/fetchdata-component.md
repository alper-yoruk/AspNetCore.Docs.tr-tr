<span data-ttu-id="0765c-101">`FetchData`Bileşen şunları gösterir:</span><span class="sxs-lookup"><span data-stu-id="0765c-101">The `FetchData` component shows how to:</span></span>
