<span data-ttu-id="ebd83-101">Aşağıdaki .NET CLı komutlarını çalıştırın:</span><span class="sxs-lookup"><span data-stu-id="ebd83-101">Run the following .NET CLI commands:</span></span>
