<span data-ttu-id="00185-101">Sınıfına aşağıdaki özellikleri ekleyin `Movie` :</span><span class="sxs-lookup"><span data-stu-id="00185-101">Add the following properties to the `Movie` class:</span></span>
