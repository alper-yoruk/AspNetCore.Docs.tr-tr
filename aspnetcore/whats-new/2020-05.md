...
- <xref:blazor/webassembly-performance-best-practices>-Blazor te performans performansı en iyi yöntemler belgesi ekleme

## <a name="security"></a>Güvenlik

### <a name="new-articles"></a>Yeni makaleler

- <xref:blazor/security/server/additional-scenarios>-Blazor sunucusu güvenlik düğümü oluştur
- <xref:blazor/security/server/index>-Blazor sunucusu güvenlik düğümü oluştur
- <xref:blazor/security/webassembly/aad-groups-roles>-AAD grupları ve rolleri ile Blazor te
...
- <xref:blazor/security/webassembly/hosted-with-identity-server>-Kimlik sunucusu ile Blazor için ad ve rol talep yapılandırması için bölüm ekleyin
