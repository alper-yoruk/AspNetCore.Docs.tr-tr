...
---
# <a name="part-5-no-locrazor-pages-with-ef-core-in-aspnet-core---data-model"></a><span data-ttu-id="e0274-103">Bölüm 5, Razor ASP.NET Core veri modelinde EF Core olan sayfalar</span><span class="sxs-lookup"><span data-stu-id="e0274-103">Part 5, Razor Pages with EF Core in ASP.NET Core - Data Model</span></span>
