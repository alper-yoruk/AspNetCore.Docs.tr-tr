...
* [AAD ile barındırılan](xref:security/blazor/webassembly/hosted-with-azure-active-directory)
...
[Authorizeview bileşeni](xref:security/blazor/index#authorizeview-component) ilkeyle birlikte kullanılabilir:
...
Bir ilke denetimi, [yordamsal mantığa kodunda de gerçekleştirilebilir](xref:security/blazor/index#procedural-logic):
