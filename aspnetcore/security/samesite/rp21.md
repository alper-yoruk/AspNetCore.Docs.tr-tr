...
---
# <a name="aspnet-core-21-no-locrazor-pages-samesite-no-loccookie-sample"></a>ASP.NET Core 2,1 Razor Pages SameSite cookie örneği
...
Aşağıdaki kod, ' a bir SameSite özniteliği yazmanın bir örneğidir cookie :
...
Yukarıdaki kodda, hem cookie kimlik doğrulaması hem de oturum durumu, `None` özniteliği bir değerle yayın `None` ve ayrıca güvenli özniteliğini olarak ayarlayın `true` .
