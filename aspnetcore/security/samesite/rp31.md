...
Cookiekimlik doğrulama, oturum durumu ve [diğer diğer bileşenler](https://docs.microsoft.com/aspnet/core/security/samesite?view=aspnetcore-3.0) aynı site seçeneklerini seçenekler aracılığıyla ayarlar Cookie , örneğin
