...
#### <a name="usage-in-razor-pages"></a>Sayfalarda kullanım Razor
...
> * [RazorPagesOptions. AllowAreas](xref:Microsoft.AspNetCore.Mvc.RazorPages.RazorPagesOptions.AllowAreas*) özelliğini şu şekilde ayarlayın `true` :
>
