...
IIS, Brotli veya gzip sıkıştırılan varlıkları sunacak şekilde *web.config* aracılığıyla yapılandırılabilir Blazor . Örnek bir yapılandırma için bkz. [web.config](webassembly/_samples/web.config?raw=true).
