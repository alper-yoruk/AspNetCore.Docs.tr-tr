...
---
# <a name="aspnet-core-no-locblazor-logging"></a><span data-ttu-id="22548-103">BlazorGünlüğe kaydetme ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="22548-103">ASP.NET Core Blazor logging</span></span>

## Blazor WebAssembly

<span data-ttu-id="22548-104">Uygulamalarda oturum açma Blazor WebAssembly `WebAssemblyHostBuilder.Logging` özelliğini içindeki özelliği kullanarak yapılandırın `Program.Main` :</span><span class="sxs-lookup"><span data-stu-id="22548-104">Configure logging in Blazor WebAssembly apps with the `WebAssemblyHostBuilder.Logging` property in `Program.Main`:</span></span>
...
## <a name="no-locblazor-webassembly-no-locsignalr-net-client-logging"></a><span data-ttu-id="22548-109">Blazor WebAssemblySignalR.NET istemci günlüğü</span><span class="sxs-lookup"><span data-stu-id="22548-109">Blazor WebAssembly SignalR .NET client logging</span></span>
...
## <a name="log-in-no-locrazor-components"></a><span data-ttu-id="22548-113">RazorBileşenlerdeki oturum açma</span><span class="sxs-lookup"><span data-stu-id="22548-113">Log in Razor components</span></span>
...
<span data-ttu-id="22548-116">Aşağıdaki örnek, bileşenleri içindeki bir günlüğü <xref:Microsoft.Extensions.Logging.ILogger> gösterir Razor :</span><span class="sxs-lookup"><span data-stu-id="22548-116">The following example demonstrates logging with an <xref:Microsoft.Extensions.Logging.ILogger> in Razor components:</span></span>
...
<span data-ttu-id="22548-117">Aşağıdaki örnek, bileşenleri içindeki bir günlüğü <xref:Microsoft.Extensions.Logging.ILoggerFactory> gösterir Razor :</span><span class="sxs-lookup"><span data-stu-id="22548-117">The following example demonstrates logging with an <xref:Microsoft.Extensions.Logging.ILoggerFactory> in Razor components:</span></span>
