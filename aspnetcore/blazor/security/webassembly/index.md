...
Webassembly içindeki kimlik doğrulama desteği, Blazor temel alınan kimlik doğrulama protokolü ayrıntılarını işlemek için kullanılan *oidc-client.js* kitaplığının üzerine kurulmuştur.
