...
---
# <a name="aspnet-core-no-locblazor-cascading-values-and-parameters"></a><span data-ttu-id="5e7ab-103">:::no-loc(Blazor):::Basamaklı değerleri ve parametreleri ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="5e7ab-103">ASP.NET Core :::no-loc(Blazor)::: cascading values and parameters</span></span>
