...
* Platform yapılandırması, uygulamanın yeniden yönlendirme URI 'SI ile Azure portal **tek sayfalı uygulama (Spa)** olarak ayarlanır.
...
Daha fazla bilgi için bkz. <xref:blazor/security/webassembly/hosted-with-azure-active-directory-b2c>.
