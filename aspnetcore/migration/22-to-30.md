...
### <a name="use-newtonsoftjson-in-an-aspnet-core-30-signalr-project"></a>ASP.NET Core 3,0 projesinde Newtonsoft.Jskullanma SignalR
...
[Önceki yönlendirme sürümlerindeki farklılıklar](xref:fundamentals/routing#differences-from-earlier-versions-of-routing)hakkında belgelerde açıklandığı gibi, bağlantı oluşturma ( `Url.Link` Örneğin ve benzer API 'ler kullanılarak) ile ilgili bazı farklılıklar vardır. Bu güncelleştirmeler şunlardır:
