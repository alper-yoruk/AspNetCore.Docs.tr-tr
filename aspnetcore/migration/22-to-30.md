...
Bu makalede, varolan bir ASP.NET Core 2.2 projesinin Core 3.0'ASP.NET nasıl güncelleştirilen açıklanmaktadır. Yeni bir ASP.NET Core 3.0 projesi oluşturmak yararlı olabilir:

* core 2.2 kodu yla ASP.NET karşılaştırın.
* İlgili değişiklikleri ASP.NET Core 3.0 projenizde kopyalayın.
