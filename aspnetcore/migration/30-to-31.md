...
`SameSite`Http tanımlama bilgilerine yönelik öznitelik uygulamaları ASP.NET Core 3,0 ile 3,1 arasında değişti. Gerçekleştirilecek eylemler için aşağıdaki kaynaklara bakın:
...
Daha fazla bilgi için bkz. [bileşenleri Razor Sayfalar ve MVC uygulamaları ile tümleştirme](/aspnet/core/blazor/components/integrate-components-into-razor-pages-and-mvc-apps?view=aspnetcore-3.1).
