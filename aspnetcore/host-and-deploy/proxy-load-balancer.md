...
Iletilen üstbilgiler ara yazılımı ( <xref:Microsoft.AspNetCore.HttpOverrides.ForwardedHeadersMiddleware> ), bu üst bilgileri okur ve ilgili alanları üzerinde doldurur <xref:Microsoft.AspNetCore.Http.HttpContext> .
