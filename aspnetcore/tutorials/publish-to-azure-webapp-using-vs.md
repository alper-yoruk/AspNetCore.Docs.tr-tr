...
MacOS 'ta çalışıyorsanız [Mac için Visual Studio kullanarak Azure App Service Için Web uygulaması yayımlama](/visualstudio/mac/publish-app-svc?view=vsmac-2019) konusuna bakın.
