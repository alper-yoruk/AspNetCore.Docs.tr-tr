...
1. Hata   >  ayıklayıcıyı eklemeden uygulamayı tarayıcıda başlatmak için hata ayıklama **olmadan Başlat** ' ı seçin. *Wwwroot/index.html* dosyası ' de sunulur `http://localhost:<port_number>` .
