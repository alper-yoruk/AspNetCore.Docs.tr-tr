...
<span data-ttu-id="bb812-108">ASP.NET Core [yapılandırma](xref:fundamentals/configuration/index) sistemi okur `ConnectionString` .</span><span class="sxs-lookup"><span data-stu-id="bb812-108">The ASP.NET Core [Configuration](xref:fundamentals/configuration/index) system reads the `ConnectionString`.</span></span> <span data-ttu-id="bb812-109">Yerel geliştirme için, dosyadaki bağlantı dizesini alır *appsettings.json* :</span><span class="sxs-lookup"><span data-stu-id="bb812-109">For local development, it gets the connection string from the *appsettings.json* file:</span></span>
...
<span data-ttu-id="bb812-111">ASP.NET Core [yapılandırma](xref:fundamentals/configuration/index) sistemi okur `ConnectionString` .</span><span class="sxs-lookup"><span data-stu-id="bb812-111">The ASP.NET Core [Configuration](xref:fundamentals/configuration/index) system reads the `ConnectionString`.</span></span> <span data-ttu-id="bb812-112">Yerel geliştirme için, dosyadaki bağlantı dizesini alır *appsettings.json* :</span><span class="sxs-lookup"><span data-stu-id="bb812-112">For local development, it gets the connection string from the *appsettings.json* file:</span></span>
...
<span data-ttu-id="bb812-159">ASP.NET Core [yapılandırma](xref:fundamentals/configuration/index) sistemi okur `ConnectionString` .</span><span class="sxs-lookup"><span data-stu-id="bb812-159">The ASP.NET Core [Configuration](xref:fundamentals/configuration/index) system reads the `ConnectionString`.</span></span> <span data-ttu-id="bb812-160">Yerel geliştirme için, dosyadaki bağlantı dizesini alır *appsettings.json* :</span><span class="sxs-lookup"><span data-stu-id="bb812-160">For local development, it gets the connection string from the *appsettings.json* file:</span></span>
...
<span data-ttu-id="bb812-162">ASP.NET Core [yapılandırma](xref:fundamentals/configuration/index) sistemi okur `ConnectionString` .</span><span class="sxs-lookup"><span data-stu-id="bb812-162">The ASP.NET Core [Configuration](xref:fundamentals/configuration/index) system reads the `ConnectionString`.</span></span> <span data-ttu-id="bb812-163">Yerel geliştirme için, dosyadaki bağlantı dizesini alır *appsettings.json* :</span><span class="sxs-lookup"><span data-stu-id="bb812-163">For local development, it gets the connection string from the *appsettings.json* file:</span></span>
