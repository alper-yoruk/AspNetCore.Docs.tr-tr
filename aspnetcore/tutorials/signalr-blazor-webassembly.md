...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="bd729-103">İle ASP.NET Core kullanma :::no-loc(SignalR)::::::no-loc(Blazor WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="bd729-103">Use ASP.NET Core :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::</span></span>
...
<span data-ttu-id="bd729-105">Bu öğretici ile kullanarak gerçek zamanlı bir uygulama oluşturma hakkında temel bilgileri öğretir :::no-loc(SignalR)::: :::no-loc(Blazor WebAssembly)::: .</span><span class="sxs-lookup"><span data-stu-id="bd729-105">This tutorial teaches the basics of building a real-time app using :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::.</span></span> <span data-ttu-id="bd729-106">Aşağıdakileri nasıl yapacağınızı öğrenirsiniz:</span><span class="sxs-lookup"><span data-stu-id="bd729-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="bd729-107">:::no-loc(Blazor WebAssembly):::Barındırılan uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="bd729-107">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="bd729-108">:::no-loc(SignalR):::İstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="bd729-108">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="bd729-109">Hub ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-109">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="bd729-110">:::no-loc(SignalR):::Hub için hizmetler ve uç nokta ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-110">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="bd729-111">:::no-loc(Razor):::Sohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="bd729-111">Add :::no-loc(Razor)::: component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="bd729-127">Barındırılan :::no-loc(Blazor WebAssembly)::: uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="bd729-127">Create a hosted :::no-loc(Blazor WebAssembly)::: app project</span></span>
...
1. <span data-ttu-id="bd729-133">**:::no-loc(Blazor)::: Uygulama** ' yı seçin ve **İleri ' yi** seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-133">Select **:::no-loc(Blazor)::: App** and select **Next**.</span></span>

1. <span data-ttu-id="bd729-134">`:::no-loc(Blazor)::::::no-loc(SignalR):::App` **Proje adı** alanına yazın.</span><span class="sxs-lookup"><span data-stu-id="bd729-134">Type `:::no-loc(Blazor)::::::no-loc(SignalR):::App` in the **Project name** field.</span></span> <span data-ttu-id="bd729-135">**Konum** girişinin doğru olduğunu onaylayın veya proje için bir konum belirtin.</span><span class="sxs-lookup"><span data-stu-id="bd729-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="bd729-136">**Oluştur** ’u seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-136">Select **Create**.</span></span>

1. <span data-ttu-id="bd729-137">**:::no-loc(Blazor WebAssembly)::: Uygulama** şablonunu seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-137">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span>
...
1. <span data-ttu-id="bd729-149">**:::no-loc(Blazor WebAssembly)::: Uygulama** şablonunu seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-149">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="bd729-150">**İleri** ’yi seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="bd729-154">**Proje adı** alanında, uygulamayı adlandırın `:::no-loc(Blazor)::::::no-loc(SignalR):::App` .</span><span class="sxs-lookup"><span data-stu-id="bd729-154">In the **Project Name** field, name the app `:::no-loc(Blazor)::::::no-loc(SignalR):::App`.</span></span> <span data-ttu-id="bd729-155">**Oluştur** ’u seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="bd729-161">:::no-loc(SignalR):::İstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="bd729-161">Add the :::no-loc(SignalR)::: client library</span></span>
...
1. <span data-ttu-id="bd729-163">**Çözüm Gezgini** , projeye sağ tıklayın `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` ve **NuGet Paketlerini Yönet** ' i seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-163">In **Solution Explorer** , right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="bd729-165">**Araştır** seçiliyken, `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` Arama kutusuna yazın.</span><span class="sxs-lookup"><span data-stu-id="bd729-165">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="bd729-166">Arama sonuçlarında, [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) paketi seçin ve ardından **Install** ' ı seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-166">In the search results, select the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="bd729-172">**Çözüm** kenar çubuğunda projeye sağ tıklayın `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` ve **NuGet Paketlerini Yönet** ' i seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-172">In the **Solution** sidebar, right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="bd729-174">**Araştır** seçiliyken, `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` Arama kutusuna yazın.</span><span class="sxs-lookup"><span data-stu-id="bd729-174">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="bd729-175">Arama sonuçlarında, paketin yanındaki onay kutusunu işaretleyin [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) ve **paket Ekle** ' yi seçin.</span><span class="sxs-lookup"><span data-stu-id="bd729-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="bd729-179">Hub ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-179">Add a :::no-loc(SignalR)::: hub</span></span>

<span data-ttu-id="bd729-180">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server`Projesinde, bir `Hubs` (plural) klasörü oluşturun ve aşağıdaki `ChatHub` sınıfı ( `Hubs/ChatHub.cs` ) ekleyin:</span><span class="sxs-lookup"><span data-stu-id="bd729-180">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="bd729-181">Hub için hizmetler ve uç nokta ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-181">Add services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>

1. <span data-ttu-id="bd729-182">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server`Projede `Startup.cs` dosyasını açın.</span><span class="sxs-lookup"><span data-stu-id="bd729-182">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="bd729-184">:::no-loc(SignalR):::Sıkıştırma ara yazılım hizmetlerini ekleme ve yanıtlama `Startup.ConfigureServices` :</span><span class="sxs-lookup"><span data-stu-id="bd729-184">Add :::no-loc(SignalR)::: and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="bd729-188">:::no-loc(Razor):::Sohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="bd729-188">Add :::no-loc(Razor)::: component code for chat</span></span>

1. <span data-ttu-id="bd729-189">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client`Projede `Pages/Index.razor` dosyasını açın.</span><span class="sxs-lookup"><span data-stu-id="bd729-189">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="bd729-226">:::no-loc(Blazor WebAssembly):::Barındırılan uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="bd729-226">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="bd729-227">:::no-loc(SignalR):::İstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="bd729-227">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="bd729-228">Hub ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-228">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="bd729-229">:::no-loc(SignalR):::Hub için hizmetler ve uç nokta ekleme :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="bd729-229">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="bd729-230">:::no-loc(Razor):::Sohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="bd729-230">Add :::no-loc(Razor)::: component code for chat</span></span>

<span data-ttu-id="bd729-231">Uygulama oluşturma hakkında daha fazla bilgi edinmek için :::no-loc(Blazor)::: :::no-loc(Blazor)::: belgelere bakın:</span><span class="sxs-lookup"><span data-stu-id="bd729-231">To learn more about building :::no-loc(Blazor)::: apps, see the :::no-loc(Blazor)::: documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="bd729-232"><xref:blazor/index>
> [:::no-loc(Identity):::Sunucu, WebSockets ve Server-Sent olayları ile taşıyıcı belirteci kimlik doğrulaması](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="bd729-232"><xref:blazor/index>
...
* [<span data-ttu-id="bd729-234">:::no-loc(SignalR)::: kimlik doğrulaması için çıkış noktaları arası anlaşma</span><span class="sxs-lookup"><span data-stu-id="bd729-234">:::no-loc(SignalR)::: cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
