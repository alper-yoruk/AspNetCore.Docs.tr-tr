...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="0584f-103">İle ASP.NET Core kullanma SignalRBlazor WebAssembly</span><span class="sxs-lookup"><span data-stu-id="0584f-103">Use ASP.NET Core SignalR with Blazor WebAssembly</span></span>
...
<span data-ttu-id="0584f-105">Bu öğretici ile kullanarak gerçek zamanlı bir uygulama oluşturma hakkında temel bilgileri öğretir SignalR Blazor WebAssembly .</span><span class="sxs-lookup"><span data-stu-id="0584f-105">This tutorial teaches the basics of building a real-time app using SignalR with Blazor WebAssembly.</span></span> <span data-ttu-id="0584f-106">Aşağıdakileri nasıl yapacağınızı öğrenirsiniz:</span><span class="sxs-lookup"><span data-stu-id="0584f-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="0584f-107">Blazor WebAssemblyBarındırılan uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="0584f-107">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="0584f-108">SignalRİstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="0584f-108">Add the SignalR client library</span></span>
> * <span data-ttu-id="0584f-109">Hub ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-109">Add a SignalR hub</span></span>
> * <span data-ttu-id="0584f-110">SignalRHub için hizmetler ve uç nokta ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-110">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="0584f-111">RazorSohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="0584f-111">Add Razor component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="0584f-127">Barındırılan Blazor WebAssembly uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="0584f-127">Create a hosted Blazor WebAssembly app project</span></span>
...
1. <span data-ttu-id="0584f-149">**Blazor WebAssembly Uygulama** şablonunu seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-149">Choose the **Blazor WebAssembly App** template.</span></span> <span data-ttu-id="0584f-150">**İleri** ’yi seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-150">Select **Next** .</span></span>
...
1. <span data-ttu-id="0584f-154">**Proje adı** alanında, uygulamayı adlandırın `BlazorSignalRApp` .</span><span class="sxs-lookup"><span data-stu-id="0584f-154">In the **Project Name** field, name the app `BlazorSignalRApp`.</span></span> <span data-ttu-id="0584f-155">**Oluştur** ’u seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-155">Select **Create** .</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="0584f-161">SignalRİstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="0584f-161">Add the SignalR client library</span></span>
...
1. <span data-ttu-id="0584f-163">**Çözüm Gezgini** , projeye sağ tıklayın `BlazorSignalRApp.Client` ve **NuGet Paketlerini Yönet** ' i seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-163">In **Solution Explorer** , right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages** .</span></span>
...
1. <span data-ttu-id="0584f-165">**Araştır** seçiliyken, `Microsoft.AspNetCore.SignalR.Client` Arama kutusuna yazın.</span><span class="sxs-lookup"><span data-stu-id="0584f-165">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="0584f-166">Arama sonuçlarında, [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) paketi seçin ve ardından **Install** ' ı seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-166">In the search results, select the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Install** .</span></span>
...
1. <span data-ttu-id="0584f-172">**Çözüm** kenar çubuğunda projeye sağ tıklayın `BlazorSignalRApp.Client` ve **NuGet Paketlerini Yönet** ' i seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-172">In the **Solution** sidebar, right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages** .</span></span>
...
1. <span data-ttu-id="0584f-174">**Araştır** seçiliyken, `Microsoft.AspNetCore.SignalR.Client` Arama kutusuna yazın.</span><span class="sxs-lookup"><span data-stu-id="0584f-174">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="0584f-175">Arama sonuçlarında, paketin yanındaki onay kutusunu işaretleyin [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) ve **paket Ekle** ' yi seçin.</span><span class="sxs-lookup"><span data-stu-id="0584f-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Add Package** .</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="0584f-179">Hub ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-179">Add a SignalR hub</span></span>

<span data-ttu-id="0584f-180">`BlazorSignalRApp.Server`Projesinde, bir `Hubs` (plural) klasörü oluşturun ve aşağıdaki `ChatHub` sınıfı ( `Hubs/ChatHub.cs` ) ekleyin:</span><span class="sxs-lookup"><span data-stu-id="0584f-180">In the `BlazorSignalRApp.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="0584f-181">Hub için hizmetler ve uç nokta ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-181">Add services and an endpoint for the SignalR hub</span></span>

1. <span data-ttu-id="0584f-182">`BlazorSignalRApp.Server`Projede `Startup.cs` dosyasını açın.</span><span class="sxs-lookup"><span data-stu-id="0584f-182">In the `BlazorSignalRApp.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="0584f-184">SignalRSıkıştırma ara yazılım hizmetlerini ekleme ve yanıtlama `Startup.ConfigureServices` :</span><span class="sxs-lookup"><span data-stu-id="0584f-184">Add SignalR and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="0584f-188">RazorSohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="0584f-188">Add Razor component code for chat</span></span>

1. <span data-ttu-id="0584f-189">`BlazorSignalRApp.Client`Projede `Pages/Index.razor` dosyasını açın.</span><span class="sxs-lookup"><span data-stu-id="0584f-189">In the `BlazorSignalRApp.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="0584f-226">Blazor WebAssemblyBarındırılan uygulama projesi oluşturma</span><span class="sxs-lookup"><span data-stu-id="0584f-226">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="0584f-227">SignalRİstemci kitaplığını ekleme</span><span class="sxs-lookup"><span data-stu-id="0584f-227">Add the SignalR client library</span></span>
> * <span data-ttu-id="0584f-228">Hub ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-228">Add a SignalR hub</span></span>
> * <span data-ttu-id="0584f-229">SignalRHub için hizmetler ve uç nokta ekleme SignalR</span><span class="sxs-lookup"><span data-stu-id="0584f-229">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="0584f-230">RazorSohbet için bileşen kodu ekle</span><span class="sxs-lookup"><span data-stu-id="0584f-230">Add Razor component code for chat</span></span>

<span data-ttu-id="0584f-231">Uygulama oluşturma hakkında daha fazla bilgi edinmek için Blazor Blazor belgelere bakın:</span><span class="sxs-lookup"><span data-stu-id="0584f-231">To learn more about building Blazor apps, see the Blazor documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="0584f-232"><xref:blazor/index>
> [IdentitySunucu, WebSockets ve Server-Sent olayları ile taşıyıcı belirteci kimlik doğrulaması](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="0584f-232"><xref:blazor/index>
...
* [<span data-ttu-id="0584f-234">SignalR kimlik doğrulaması için çıkış noktaları arası anlaşma</span><span class="sxs-lookup"><span data-stu-id="0584f-234">SignalR cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
